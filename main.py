...
def parse_argument():
    ...
    parser.add_argument("--use_dae", dest="use_dae", action="store_true")
...
if __name__ == "__main__":
    ...
    if not args.eval:
        ...
        print(f"mlp_dropout={args.mlp_dropout}")
        print(f"use_dae={args.use_dae}")
        print(f"dae_noise_std={args.dae_noise_std}")
